...
function App() {
  ...
  useEffect(() => {
    ...
    const loadNodes = async () => {
      try {
        ...
        console.log('Nessun nodo esistente, è normale');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Errore nella creazione del nodo: ' + error.message);
    }
  };
              ...
              <div key={node.id || idx} className="node-card">
                ...
                <div className="futurogram-container">
                  <svg width="400" height="400" viewBox="0 0 400 400">
                    ...
                    <text x="200" y="95" textAnchor="middle" fill="white">DECISIONE</text>
